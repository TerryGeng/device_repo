...
class SD_Wave(SD_Object):
    ...
    def newFromArrayDouble(self, waveformType, waveformDataA, waveformDataB=None):
        if len(waveformDataA) > 0 and (waveformDataB is None or len(waveformDataA) == len(waveformDataB)):
            ...
            self._SD_Object__handle = self._SD_Object__core_dll.SD_Wave_newFromArrayDouble(waveformType,
                                                                                           waveform_dataA_C._length_,
                                                                                           waveform_dataA_C,
                                                                                           waveform_dataB_C)
    ...
    def newFromArrayInteger(self, waveformType, waveformDataA, waveformDataB=None):
        if len(waveformDataA) > 0 and (waveformDataB is None or len(waveformDataA) == len(waveformDataB)):
            ...
            self._SD_Object__handle = self._SD_Object__core_dll.SD_Wave_newFromArrayInteger(waveformType,
                                                                                            waveform_dataA_C._length_,
                                                                                            waveform_dataA_C,
                                                                                            waveform_dataB_C)
...
class SD_Module(SD_Object):
    def openWithSerialNumber(self, partNumber, serialNumber):
        if self._SD_Object__handle <= 0:
            self._SD_Object__handle = self._SD_Object__core_dll.SD_Module_openWithSerialNumber(partNumber.encode(),
                                                                                               serialNumber.encode())
    ...
    def openWithSlot(self, partNumber, nChassis, nSlot):
        if self._SD_Object__handle <= 0:
            self._SD_Object__handle = self._SD_Object__core_dll.SD_Module_openWithSlot(partNumber.encode(), nChassis,
                                                                                       nSlot)
    ...
    def openWithSlotCompatibility(self, partNumber, nChassis, nSlot, compatibility):
        if self._SD_Object__handle <= 0:
            self._SD_Object__handle = self._SD_Object__core_dll.SD_Module_openWithSlotCompatibility(partNumber.encode(),
                                                                                                    nChassis, nSlot,
                                                                                                    compatibility)
    ...
    def readRegisterByNumber(self, regNumber):
        ...
        if self._SD_Object__handle > 0:
            error = c_int32()
            varValue = self._SD_Object__core_dll.SD_Module_readRegister(self._SD_Object__handle, regNumber,
                                                                        byref(error))
            error = error.value
        else:
    ...
    def readRegisterByName(self, regName):
        ...
        if self._SD_Object__handle > 0:
            error = c_int32()
            varValue = self._SD_Object__core_dll.SD_Module_readRegisterWithName(self._SD_Object__handle,
                                                                                regName.encode(), byref(error))
            error = error.value
        else:
            error = SD_Error.MODULE_NOT_OPENED
    ...
    def readRegisterDoubleByNumber(self, regNumber, unit):
        ...
        if self._SD_Object__handle > 0:
            ...
            varValue = self._SD_Object__core_dll.SD_Module_readDoubleRegister(self._SD_Object__handle, regNumber,
                                                                              unit.encode(), byref(error))
            error = error.value
        else:
            error = SD_Error.MODULE_NOT_OPENED
    ...
    def readRegisterDoubleByName(self, regName, unit):
        ...
        if self._SD_Object__handle > 0:
            ...
            varValue = self._SD_Object__core_dll.SD_Module_readDoubleRegisterWithName(self._SD_Object__handle,
                                                                                      regName.encode(), unit.encode(),
                                                                                      byref(error))
            error = error.value
        else:
            error = SD_Error.MODULE_NOT_OPENED
    ...
    def writeRegisterByName(self, regName, varValue):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_Module_writeRegisterWithName(self._SD_Object__handle, regName.encode(),
                                                                             varValue)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def writeRegisterDoubleByNumber(self, regNumber, value, unit):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_Module_writeDoubleRegister(self._SD_Object__handle, regNumber,
    ...
    def writeRegisterDoubleByName(self, regName, value, unit):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_Module_writeDoubleRegisterWithName(self._SD_Object__handle,
                                                                                   regName.encode(), c_double(value),
                                                                                   unit.encode())
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def translateTriggerPXItoExternalTriggerLine(self, trigger):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_Module_translateTriggerPXItoExternalTriggerLine(self._SD_Object__handle,
                                                                                                trigger)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def translateTriggerIOtoExternalTriggerLine(self, trigger):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_Module_translateTriggerIOtoExternalTriggerLine(self._SD_Object__handle,
                                                                                               trigger)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def FPGAreadPCport(self, port, nDW, address, addressMode, accessMode):
        if self._SD_Object__handle > 0:
            if nDW > 0:
                nDW = int(nDW)
                data = (c_int * nDW)()
                error = self._SD_Object__core_dll.SD_Module_FPGAreadPCport(self._SD_Object__handle, port, data, nDW,
    ...
    def FPGAwritePCport(self, port, buffer, address, addressMode, accessMode):
        if self._SD_Object__handle > 0:
            if len(buffer) > 0:
                ...
                return self._SD_Object__core_dll.SD_Module_FPGAwritePCport(self._SD_Object__handle, port, data,
                                                                           data._length_, address, addressMode,
                                                                           accessMode)
            else:
                return SD_Error.INVALID_VALUE
        else:
    ...
    def compilationErrorMessageHVI(self, errorIndex):
        ...
        if self._SD_Object__handle > 0:
            error = self._SD_Object__core_dll.SD_Module_compilationErrorMessageHVI(self._SD_Object__handle, errorIndex,
                                                                                   message, len(message))
...
class SD_AOU(SD_Module):
    ...
    def clockSetFrequency(self, frequency, mode=1):
        if self._SD_Object__handle > 0:
            ...
            result = self._SD_Object__core_dll.SD_AOU_clockSetFrequency(self._SD_Object__handle, c_double(frequency),
                                                                        mode)
    ...
    def clockResetPhase(self, triggerBehavior, triggerSource, skew=0.0):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AOU_clockResetPhase(self._SD_Object__handle, triggerBehavior,
                                                                    triggerSource, c_double(skew))
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def channelAmplitude(self, nChannel, amplitude):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AOU_channelAmplitude(self._SD_Object__handle, nChannel,
                                                                     c_double(amplitude))
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def channelFrequency(self, nChannel, frequency):
        if self._SD_Object__handle > 0:
            ...
            return self._SD_Object__core_dll.SD_AOU_channelFrequency(self._SD_Object__handle, nChannel,
                                                                     c_double(frequency))
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def modulationAngleConfig(self, nChannel, modulationType, deviationGain):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AOU_modulationAngleConfig(self._SD_Object__handle, nChannel,
                                                                          modulationType, c_double(deviationGain))
        else:
            return SD_Error.MODULE_NOT_OPENED

    def modulationAmplitudeConfig(self, nChannel, modulationType, deviationGain):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AOU_modulationAmplitudeConfig(self._SD_Object__handle, nChannel,
                                                                              modulationType, c_double(deviationGain))
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def waveformReLoad(self, waveformObject, waveformNumber, paddingMode=0):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AOU_waveformReLoad(self._SD_Object__handle,
                                                                   waveformObject._SD_Object__handle, waveformNumber,
                                                                   paddingMode)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def waveformReLoadArrayInt16(self, waveformType, dataRaw, waveformNumber, paddingMode=0):
        if self._SD_Object__handle > 0:
            if len(dataRaw) > 0:
                ...
                return self._SD_Object__core_dll.SD_AOU_waveformReLoadArrayInt16(self._SD_Object__handle, waveformType,
                                                                                 dataC._length_, dataC, waveformNumber,
                                                                                 paddingMode)
            else:
                return SD_Error.INVALID_VALUE
        else:
    ...
    def waveformLoad(self, waveformObject, waveformNumber, paddingMode=0):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AOU_waveformLoad(self._SD_Object__handle,
                                                                 waveformObject._SD_Object__handle, waveformNumber,
                                                                 paddingMode)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def waveformLoadInt16(self, waveformType, dataRaw, waveformNumber, paddingMode=0):
        if self._SD_Object__handle > 0:
            if len(dataRaw) > 0:
                dataC = (c_short * len(dataRaw))(*dataRaw)
                return self._SD_Object__core_dll.SD_AOU_waveformLoadArrayInt16(self._SD_Object__handle, waveformType,
                                                                               dataC._length_, dataC, waveformNumber,
                                                                               paddingMode)
            else:
                return SD_Error.INVALID_VALUE
    ...
    def AWGqueueWaveform(self, nAWG, waveformNumber, triggerMode, startDelay, cycles, prescaler):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AOU_AWGqueueWaveform(self._SD_Object__handle, nAWG, waveformNumber,
                                                                     triggerMode, startDelay, cycles, prescaler)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def AWGfromArray(self, nAWG, triggerMode, startDelay, cycles, prescaler, waveformType, waveformDataA,
                     waveformDataB=None, paddingMode=0):
        if self._SD_Object__handle > 0:
            if len(waveformDataA) > 0 and (waveformDataB is None or len(waveformDataA) == len(waveformDataB)):
                waveform_dataA_C = (c_double * len(waveformDataA))(*waveformDataA)
                if waveformDataB is None:
                ...
                return self._SD_Object__core_dll.SD_AOU_AWGfromArray(self._SD_Object__handle, nAWG, triggerMode,
                                                                     startDelay, cycles, prescaler, waveformType,
                                                                     waveform_dataA_C._length_, waveform_dataA_C,
                                                                     waveform_dataB_C, paddingMode)
            else:
                return SD_Error.INVALID_VALUE
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def AWGFromFile(self, nAWG, waveformFile, triggerMode, startDelay, cycles, prescaler, paddingMode=0):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AOU_AWGfromFile(self._SD_Object__handle, nAWG, waveformFile.encode(),
    ...
    def AWGtriggerExternalConfig(self, nAWG, externalSource, triggerBehavior, sync=SD_SyncModes.SYNC_CLK10):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AOU_AWGtriggerExternalConfig(self._SD_Object__handle, nAWG,
                                                                             externalSource, triggerBehavior, sync)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def AWGqueueMarkerConfig(self, nAWG, markerMode, trgPXImask, trgIOmask, value, syncMode, length, delay):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AOU_AWGqueueMarkerConfig(self._SD_Object__handle, nAWG, markerMode,
                                                                         trgPXImask, trgIOmask, value, syncMode, length,
                                                                         delay)
        else:
            return SD_Error.MODULE_NOT_OPENED
...
class SD_DIO(SD_Module):
    ...
    def IOstandardConfig(self, portSector, logicStandard):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_DIO_IOstandardConfig(self._SD_Object__handle, portSector,
                                                                     logicStandard)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def IOdirectionConfig(self, lineMask, direction):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_DIO_IOdirectionConfig(self._SD_Object__handle, c_longlong(lineMask),
                                                                      direction)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def portWriteWithMask(self, nPort, portValue, lineMask):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_DIO_portWriteWithMask(self._SD_Object__handle, nPort,
                                                                      c_longlong(portValue), c_longlong(lineMask))
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def busSamplingConfig(self, nBus, switchStrobe, strobeOn, strobeType, strobeDelay, prescaler=0, debouncing=0):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_DIO_busSamplingConfig(self._SD_Object__handle, nBus, switchStrobe,
                                                                      strobeOn, strobeType, c_float(strobeDelay),
                                                                      prescaler, debouncing)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def waveformMemorySetWriteAddress(self, writeAddress):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_DIO_waveformMemorySetWriteAddress(self._SD_Object__handle,
                                                                                  writeAddress)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def waveformReLoad(self, waveformObject, waveformNumber, paddingMode=0):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_DIO_waveformReLoad(self._SD_Object__handle,
                                                                   waveformObject._SD_Object__handle, waveformNumber,
                                                                   paddingMode)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def waveformReLoadArrayInt16(self, waveformType, dataRaw, waveformNumber, paddingMode=0):
        if self._SD_Object__handle > 0:
            if len(dataRaw) > 0:
                dataC = (c_short * len(dataRaw))(*dataRaw)
                return self._SD_Object__core_dll.SD_DIO_waveformReLoadArrayInt16(self._SD_Object__handle, waveformType,
                                                                                 dataC._length_, dataC, waveformNumber,
                                                                                 paddingMode)
            else:
                return SD_Error.INVALID_VALUE
    ...
    def waveformLoad(self, waveformObject, waveformNumber, paddingMode=0):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_DIO_waveformLoad(self._SD_Object__handle,
                                                                 waveformObject._SD_Object__handle, waveformNumber,
                                                                 paddingMode)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def waveformLoadArrayInt16(self, waveformType, dataRaw, waveformNumber, paddingMode=0):
        if self._SD_Object__handle > 0:
            if len(dataRaw) > 0:
                dataC = (c_short * len(dataRaw))(*dataRaw)
                return self._SD_Object__core_dll.SD_DIO_waveformLoadArrayInt16(self._SD_Object__handle, waveformType,
                                                                               dataC._length_, dataC, waveformNumber,
                                                                               paddingMode)
            else:
                return SD_Error.INVALID_VALUE
    ...
    def DWGqueueWaveform(self, nDWG, waveformNumber, triggerMode, startDelay, cycles, prescaler):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_DIO_DWGqueueWaveform(self._SD_Object__handle, nDWG, waveformNumber,
                                                                     triggerMode, startDelay, cycles, prescaler)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def DWGfromFile(self, nDWG, waveformFile, triggerMode, startDelay, cycles, prescaler, paddingMode=0):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_DIO_DWGfromFile(self._SD_Object__handle, nDWG, waveformFile.encode(),
                                                                triggerMode, startDelay, cycles, prescaler,
                                                                paddingMode)
        else:
            return SD_Error.MODULE_NOT_OPENED

    def DWG(self, nDWG, triggerMode, startDelay, cycles, prescaler, waveformType, waveformDataA, waveformDataB=None,
            paddingMode=0):
        if self._SD_Object__handle > 0:
            if len(waveformDataA) > 0 and (waveformDataB is None or len(waveformDataA) == len(waveformDataB)):
                waveform_dataA_C = (c_int * len(waveformDataA))(*waveformDataA)
                ...
                return self._SD_Object__core_dll.SD_DIO_DWGfromArray(self._SD_Object__handle, nDWG, triggerMode,
                                                                     startDelay, cycles, prescaler, waveformType,
                                                                     waveform_dataA_C._length_, waveform_dataA_C,
                                                                     waveform_dataB_C, paddingMode)
            else:
    ...
    def DWGtriggerExternalConfig(self, nDWG, externalSource, triggerBehavior):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_DIO_DWGtriggerExternalConfig(self._SD_Object__handle, nDWG,
                                                                             externalSource, triggerBehavior)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def DAQread(self, nDAQ, nPoints, timeOut=0):
        if self._SD_Object__handle > 0:
            if nPoints > 0:
                ...
                nPointsOrError = self._SD_Object__core_dll.SD_DIO_DAQread(self._SD_Object__handle, nDAQ, data, nPoints,
                                                                          timeOut)
    ...
    def DAQconfig(self, nDAQ, nDAQpointsPerCycle, nCycles, prescaler, triggerMode):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_DIO_DAQconfig(self._SD_Object__handle, nDAQ, nDAQpointsPerCycle,
                                                              nCycles, prescaler, triggerMode)
        else:
            return SD_Error.MODULE_NOT_OPENED

    def DAQtriggerExternalConfig(self, nDAQ, externalSource, triggerBehavior):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_DIO_DAQtriggerExternalConfig(self._SD_Object__handle, nDAQ,
                                                                             externalSource, triggerBehavior)
        else:
            return SD_Error.MODULE_NOT_OPENED
...
class SD_AIN(SD_Module):
    def channelInputConfig(self, channel, fullScale, impedance, coupling):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AIN_channelInputConfig(self._SD_Object__handle, channel,
                                                                       c_double(fullScale), impedance, coupling)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def channelPrescalerConfigMultiple(self, mask, prescaler):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AIN_channelPrescalerConfigMultiple(self._SD_Object__handle, mask,
                                                                                   prescaler)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def channelTriggerConfig(self, channel, analogTriggerMode, threshold):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AIN_channelTriggerConfig(self._SD_Object__handle, channel,
                                                                         analogTriggerMode, c_double(threshold))
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def clockSetFrequency(self, frequency, mode=1):
        if self._SD_Object__handle > 0:
            ...
            result = self._SD_Object__core_dll.SD_AIN_clockSetFrequency(self._SD_Object__handle, c_double(frequency),
                                                                        mode)
    ...
    def clockResetPhase(self, triggerBehavior, PXItrigger, skew=0.0):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AIN_clockResetPhase(self._SD_Object__handle, triggerBehavior,
                                                                    PXItrigger, c_double(skew))
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def DAQconfig(self, channel, pointsPerCycle, nCycles, triggerDelay, triggerMode):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AIN_DAQconfig(self._SD_Object__handle, channel, pointsPerCycle, nCycles,
    ...
    def DAQtriggerConfig(self, channel, digitalTriggerMode, digitalTriggerSource, analogTriggerMask):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AIN_DAQtriggerConfig(self._SD_Object__handle, channel,
                                                                     digitalTriggerMode, digitalTriggerSource,
                                                                     analogTriggerMask)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def DAQanalogTriggerConfig(self, channel, analogTriggerMask):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AIN_DAQanalogTriggerConfig(self._SD_Object__handle, channel,
                                                                           analogTriggerMask)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def DAQdigitalTriggerConfig(self, channel, triggerSource, triggerBehavior):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AIN_DAQdigitalTriggerConfig(self._SD_Object__handle, channel,
                                                                            triggerSource, triggerBehavior)
        else:
            return SD_Error.MODULE_NOT_OPENED

    def DAQtriggerExternalConfig(self, nDAQ, externalSource, triggerBehavior, sync=SD_SyncModes.SYNC_NONE):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AIN_DAQtriggerExternalConfig(self._SD_Object__handle, nDAQ,
                                                                             externalSource, triggerBehavior, sync)
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def DAQread(self, nDAQ, nPoints, timeOut=0):
        if self._SD_Object__handle > 0:
            if nPoints > 0:
                ...
                nPointsOrError = self._SD_Object__core_dll.SD_AIN_DAQread(self._SD_Object__handle, nDAQ, data, nPoints,
                                                                          timeOut)
    ...
    def DAQbufferPoolConfig(self, nDAQ, nPoints, timeOut=0):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_AIN_DAQbufferPoolConfig(self._SD_Object__handle, nDAQ, c_void_p(0),
                                                                        nPoints, timeOut, c_void_p(0), c_void_p(0))
        else:
            return SD_Error.MODULE_NOT_OPENED
    ...
    def DAQbufferGet(self, nDAQ):
        if self._SD_Object__handle > 0:
            ...
            error = c_int32()
            readPoints = c_int32()
            data = self._SD_Object__core_dll.SD_AIN_DAQbufferGet(self._SD_Object__handle, nDAQ, byref(readPoints),
                                                                 byref(error))
            error = error.value
        ...
        if self._SD_Object__handle > 0:
            if data is not None:
                ...
                if size > 0:
                    ...
                    resultSize = self._SD_Object__core_dll.SD_AIN_FFT(self._SD_Object__handle, channel, dataC, size,
                                                                      moduleC, resultSize, phaseC, dB, windowType)
...
class SD_HVI(SD_Object):
    ...
    def compilationErrorMessage(self, errorIndex):
        ...
        if self._SD_Object__handle > 0:
            error = self._SD_Object__core_dll.SD_HVI_compilationErrorMessage(self._SD_Object__handle, errorIndex,
                                                                             message, len(message))
    ...
    def assignHardwareWithIndexAndSerialNumber(self, index, partNumber, serialNumber):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_HVI_assignHardwareWithIndexAndSerialNumber(self._SD_Object__handle,
                                                                                           index, partNumber.encode(),
                                                                                           serialNumber.encode())
        else:
            return SD_Error.HVI_NOT_OPENED
    ...
    def assignHardwareWithIndexAndSlot(self, index, nChassis, nSlot):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_HVI_assignHardwareWithIndexAndSlot(self._SD_Object__handle, index,
                                                                                   nChassis, nSlot)
        else:
            return SD_Error.HVI_NOT_OPENED
    ...
    def assignHardwareWithUserNameAndSerialNumber(self, moduleUserName, partNumber, serialNumber):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_HVI_assignHardwareWithUserNameAndSerialNumber(self._SD_Object__handle,
                                                                                              moduleUserName.encode(),
                                                                                              partNumber.encode(),
                                                                                              serialNumber.encode())
        else:
            return SD_Error.HVI_NOT_OPENED
    ...
    def assignHardwareWithUserNameAndSlot(self, moduleUserName, nChassis, nSlot):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_HVI_assignHardwareWithUserNameAndSlot(self._SD_Object__handle,
                                                                                      moduleUserName.encode(), nChassis,
                                                                                      nSlot)
        else:
            return SD_Error.HVI_NOT_OPENED
    ...
    def assignHardwareWithUserNameAndModuleID(self, moduleUserName, module):
        if self._SD_Object__handle > 0:
            if module is not None and module.isOpen():
                return self._SD_Object__core_dll.SD_HVI_assignHardwareWithUserNameAndModuleID(self._SD_Object__handle,
                                                                                              moduleUserName.encode(),
    ...
    def removeModuleWithUserName(self, moduleUserName):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_HVI_removeModuleWithUserName(self._SD_Object__handle,
                                                                             moduleUserName.encode())
        else:
            return SD_Error.HVI_NOT_OPENED
    ...
    def getModuleByName(self, moduleUserName):
        if self._SD_Object__handle > 0:
            moduleHandle = self._SD_Object__core_dll.SD_HVI_getModuleIDwithUserName(self._SD_Object__handle,
                                                                                    moduleUserName.encode())
    ...
    def readIntegerConstantWithIndex(self, moduleIndex, constantName):
        ...
        if self._SD_Object__handle > 0:
            error = self._SD_Object__core_dll.SD_HVI_readIntegerConstantWithIndex(self._SD_Object__handle, moduleIndex,
    ...
    def readIntegerConstantWithUserName(self, moduleUserName, constantName):
        ...
        if self._SD_Object__handle > 0:
            error = self._SD_Object__core_dll.SD_HVI_readIntegerConstantWithUserName(self._SD_Object__handle,
                                                                                     moduleUserName.encode(),
                                                                                     constantName.encode(),
                                                                                     byref(value))
    ...
    def writeIntegerConstantWithIndex(self, moduleIndex, constantName, value):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_HVI_writeIntegerConstantWithIndex(self._SD_Object__handle, moduleIndex,
    ...
    def writeIntegerConstantWithUserName(self, moduleUserName, constantName, value):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_HVI_writeIntegerConstantWithUserName(self._SD_Object__handle,
                                                                                     moduleUserName.encode(),
                                                                                     constantName.encode(), value)
        else:
            return SD_Error.HVI_NOT_OPENED
    ...
    def readDoubleConstantWithIndex(self, moduleIndex, constantName):
        ...
        if self._SD_Object__handle > 0:
            error = self._SD_Object__core_dll.SD_HVI_readDoubleConstantWithIndex(self._SD_Object__handle, moduleIndex,
                                                                                 constantName.encode(), byref(value),
                                                                                 byref(unit))
    ...
    def readDoubleConstantWithUserName(self, moduleUserName, constantName):
        ...
        if self._SD_Object__handle > 0:
            error = self._SD_Object__core_dll.SD_HVI_readDoubleConstantWithUserName(self._SD_Object__handle,
                                                                                    moduleUserName.encode(),
                                                                                    constantName.encode(), byref(value),
                                                                                    byref(unit))
    ...
    def writeDoubleConstantWithIndex(self, moduleIndex, constantName, value, unit):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_HVI_writeDoubleConstantWithIndex(self._SD_Object__handle, moduleIndex,
                                                                                 constantName.encode(), c_double(value),
                                                                                 unit.encode())
        else:
            return SD_Error.HVI_NOT_OPENED
    ...
    def writeDoubleConstantWithUserName(self, moduleUserName, constantName, value, unit):
        if self._SD_Object__handle > 0:
            return self._SD_Object__core_dll.SD_HVI_writeDoubleConstantWithUserName(self._SD_Object__handle,
                                                                                    moduleUserName.encode(),
                                                                                    constantName.encode(),
                                                                                    c_double(value), unit.encode())
        else:
